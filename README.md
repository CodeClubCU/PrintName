...
2) Clone it<br>  
3) Pick one or more Programming Language of Your Choice(C++,Java,Python, Javascript, C) and Add Your Name to the Array/Vector already defined in the code<br>
